...
|------------------|----------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
| `bedrock_llm_id` | Identifies which Bedrock model to use for generation.                                                                | Single shared SSM parameter (`BEDROCK_LLM_PARAM`), used by all functions     | Must match a valid Bedrock model ID or cross-region inference profile ARN (e.g., `"meta.llama3-70b-instruct-v1:0"`, `"arn:aws:bedrock:{region}:{account}:inference-profile/us.anthropic.claude-sonnet-4-6-20250514-v1:0"`) |
